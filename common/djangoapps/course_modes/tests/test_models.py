...
class CourseModeModelTest(TestCase):
    ...
    def test_enrollment_mode_display(self, mode, verification_status):
        if mode == "verified":
            assert enrollment_mode_display(mode, verification_status, self.course_key) == self._enrollment_display_modes_dicts(verification_status)
            assert enrollment_mode_display(mode, verification_status, self.course_key) == self._enrollment_display_modes_dicts(verification_status)
            assert enrollment_mode_display(mode, verification_status, self.course_key) == self._enrollment_display_modes_dicts(verification_status)
        elif mode == "honor":
            assert enrollment_mode_display(mode, verification_status, self.course_key) == self._enrollment_display_modes_dicts(mode)
        elif mode == "audit":
            assert enrollment_mode_display(mode, verification_status, self.course_key) == self._enrollment_display_modes_dicts(mode)
