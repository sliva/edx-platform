...
class BulkChangeEnrollmentTests(SharedModuleStoreTestCase):
    ...
    def test_with_org_and_course_key(self):
        ...
        assert 'Error: one of the arguments -c/--course -o/--org is required' == text_type(err.exception)
    ...
    def test_with_invalid_org(self):
        ...
        assert 'No courses exist for the org "fakeX".' == text_type(err.exception)
    ...
    def test_without_to_mode(self):
        ...
        assert 'Error: the following arguments are required: -t/--to_mode' == text_type(err.exception)
    ...
    def test_bad_course_id(self):
        ...
        assert 'Course ID yolo is invalid.' == text_type(err.exception)
    ...
    def test_nonexistent_course_id(self):
        ...
        assert 'The given course course-v1:testX+test+2016 does not exist.' == text_type(err.exception)
