...
class TestPasswordPolicy(TestCase):
    ...
    def test_password_length_too_short(self):
        ...
        assert obj['password'][0]['user_message'] == 'This password is too short. It must contain at least 6 characters.'
    ...
    def test_password_length_too_long(self):
        ...
        assert response.status_code == 400
        obj = json.loads(response.content.decode('utf-8'))
        assert obj['password'][0]['user_message'] == 'This password is too long. It must contain no more than 12 characters.'
