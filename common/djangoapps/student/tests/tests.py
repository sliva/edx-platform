...
class CourseEndingTest(ModuleStoreTestCase):
    ...
    def test_cert_info(self):
        ...
        assert _cert_info(user, course, None) == {'status': 'processing', 'show_survey_button': False, 'can_unenroll': True}

        cert_status = {'status': 'unavailable', 'mode': 'honor', 'uuid': None}
        assert _cert_info(user, course, cert_status) == {'status': 'processing', 'show_survey_button': False, 'mode': 'honor', 'linked_in_url': None, 'can_unenroll': True}
        ...
        with patch('lms.djangoapps.grades.course_grade_factory.CourseGradeFactory.read') as patch_persisted_grade:
            ...
            assert _cert_info(user, course, cert_status) == {'status': 'generating', 'show_survey_button': True, 'survey_url': survey_url, 'grade': '1.0', 'mode': 'honor', 'linked_in_url': None, 'can_unenroll': False}

        cert_status = {'status': 'generating', 'grade': '0.67', 'mode': 'honor', 'uuid': None}
        assert _cert_info(user, course, cert_status) == {'status': 'generating', 'show_survey_button': True, 'survey_url': survey_url, 'grade': '0.67', 'mode': 'honor', 'linked_in_url': None, 'can_unenroll': False}
        ...
        assert _cert_info(user, course, cert_status) == {'status': 'downloadable', 'download_url': cert.download_url, 'show_survey_button': True, 'survey_url': survey_url, 'grade': '0.67', 'mode': 'honor', 'linked_in_url': None, 'can_unenroll': False}
        ...
        assert _cert_info(user, course, cert_status) == {'status': 'notpassing', 'show_survey_button': True, 'survey_url': survey_url, 'grade': '0.67', 'mode': 'honor', 'linked_in_url': None, 'can_unenroll': True}
        ...
        assert _cert_info(user, course2, cert_status) == {'status': 'notpassing', 'show_survey_button': False, 'grade': '0.67', 'mode': 'honor', 'linked_in_url': None, 'can_unenroll': True}
        ...
        cert_status = {'status': 'unavailable', 'mode': 'honor', 'uuid': None}
        assert _cert_info(user, course2, cert_status) == {'status': 'processing', 'show_survey_button': False, 'can_unenroll': True}
    ...
    def test_cert_grade(self, persisted_grade, cert_grade):
        ...
        with patch('lms.djangoapps.grades.course_grade_factory.CourseGradeFactory.read') as patch_persisted_grade:
            ...
            assert _cert_info(user, course, cert_status) == {'status': 'generating', 'show_survey_button': True, 'survey_url': survey_url, 'grade': str(expected_grade), 'mode': 'honor', 'linked_in_url': None, 'can_unenroll': False}
    ...
    def test_cert_grade_no_grades(self):
        ...
        with patch('lms.djangoapps.grades.course_grade_factory.CourseGradeFactory.read') as patch_persisted_grade:
            ...
            assert _cert_info(user, course, cert_status) == {'status': 'processing', 'show_survey_button': False, 'can_unenroll': True}
