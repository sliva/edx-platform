...
class CAPAProblemTest(unittest.TestCase):
    ...
    def test_label_and_description_inside_responsetype(self, question):
        ...
        * <label> tag is removed to avoid duplication
        ...
        assert problem.problem_data == {'1_2_1': {'label': question, 'descriptions': {'description_1_1_1': 'Only the paranoid survive.'}}}
    ...
    def test_neither_label_tag_nor_attribute(self, question1, question2):
        ...
        problem = new_loncapa_problem(xml)
        assert problem.problem_data == {'1_2_1': {'label': question1, 'descriptions': {}}, '1_3_1': {'label': question2, 'descriptions': {}}}
    ...
    def test_multiple_descriptions(self):
        ...
        """.format(desc1, desc2)
        problem = new_loncapa_problem(xml)
        assert problem.problem_data == {'1_2_1': {'label': '___ requires sacrifices.', 'descriptions': {'description_1_1_1': desc1, 'description_1_1_2': desc2}}}
    ...
    def test_multiple_questions_problem(self):
        ...
        * <label> tag is removed to avoid duplication
        ...
        """
        problem = new_loncapa_problem(xml)
        assert problem.problem_data == {'1_2_1': {'label': 'Select the correct synonym of paranoid?', 'descriptions': {'description_1_1_1': 'Only the paranoid survive.'}}, '1_3_1': {'label': 'What Apple device competed with the portable CD player?', 'descriptions': {'description_1_2_1': 'Device looks like an egg plant.'}}}
        assert len(problem.tree.xpath('//label')) == 0
    ...
    def test_multiple_inputtypes(self, group_label):
        ...
        problem = new_loncapa_problem(xml)
        assert problem.problem_data == {'1_2_1': {'group_label': group_label, 'label': input1_label, 'descriptions': {}}, '1_2_2': {'group_label': group_label, 'label': input2_label, 'descriptions': {}}}
