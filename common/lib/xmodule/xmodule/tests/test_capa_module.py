...
class ProblemBlockTest(unittest.TestCase):  # lint-amnesty, pylint: disable=missing-class-docstring
    ...
    def test_check_unmask(self):
        ...
        with patch.object(module.runtime, 'publish') as mock_track_function:
            ...
            assert event_info['permutation'][CapaFactory.answer_key()] == ('shuffle', ['choice_3', 'choice_1', 'choice_2', 'choice_0'])
    ...
    def test_check_unmask_answerpool(self):
        ...
        with patch.object(module.runtime, 'publish') as mock_track_function:
            ...
            assert event_info['answers'][CapaFactory.answer_key()] == 'choice_2'
            # 'permutation' key added to record how problem was shown
            assert event_info['permutation'][CapaFactory.answer_key()] == ('answerpool', ['choice_1', 'choice_3', 'choice_2', 'choice_0'])
...
class ProblemBlockXMLTest(unittest.TestCase):  # lint-amnesty, pylint: disable=missing-class-docstring
    ...
    def test_all_response_types(self, response_tag):
        ...
        assert descriptor.index_dictionary() == {'content_type': ProblemBlock.INDEX_CONTENT_TYPE, 'problem_types': [response_tag], 'content': {'display_name': name, 'capa_content': ''}}
    ...
    def test_response_types_ignores_non_response_tags(self):
        ...
        assert descriptor.index_dictionary() == {'content_type': ProblemBlock.INDEX_CONTENT_TYPE, 'problem_types': ['multiplechoiceresponse'], 'content': {'display_name': name, 'capa_content': ' Label Some comment Apple Banana Chocolate Donut '}}
    ...
    def test_solutions_not_indexed(self):
        ...
        descriptor = self._create_descriptor(xml, name=name)
        assert descriptor.index_dictionary() == {'content_type': ProblemBlock.INDEX_CONTENT_TYPE, 'problem_types': [], 'content': {'display_name': name, 'capa_content': ' '}}
    ...
    def test_indexing_checkboxes(self):
        ...
        assert descriptor.index_dictionary() == {'content_type': ProblemBlock.INDEX_CONTENT_TYPE, 'problem_types': ['choiceresponse'], 'content': {'display_name': name, 'capa_content': capa_content.replace('\n', ' ')}}
    ...
    def test_indexing_dropdown(self):
        ...
        assert descriptor.index_dictionary() == {'content_type': ProblemBlock.INDEX_CONTENT_TYPE, 'problem_types': ['optionresponse'], 'content': {'display_name': name, 'capa_content': capa_content.replace('\n', ' ')}}
    ...
    def test_indexing_multiple_choice(self):
        ...
        """)
        assert descriptor.problem_types == {'multiplechoiceresponse'}
        assert descriptor.index_dictionary() == {'content_type': ProblemBlock.INDEX_CONTENT_TYPE, 'problem_types': ['multiplechoiceresponse'], 'content': {'display_name': name, 'capa_content': capa_content.replace('\n', ' ')}}
    ...
    def test_indexing_numerical_input(self):
        ...
        assert descriptor.index_dictionary() == {'content_type': ProblemBlock.INDEX_CONTENT_TYPE, 'problem_types': ['numericalresponse'], 'content': {'display_name': name, 'capa_content': capa_content.replace('\n', ' ')}}
    ...
    def test_indexing_text_input(self):
        ...
        assert descriptor.index_dictionary() == {'content_type': ProblemBlock.INDEX_CONTENT_TYPE, 'problem_types': ['stringresponse'], 'content': {'display_name': name, 'capa_content': capa_content.replace('\n', ' ')}}
    ...
    def test_indexing_problem_with_html_tags(self):
        ...
        capa_content = textwrap.dedent("""
            ...
            HTML end.
        """)
        assert descriptor.index_dictionary() == {'content_type': ProblemBlock.INDEX_CONTENT_TYPE, 'problem_types': [], 'content': {'display_name': name, 'capa_content': capa_content.replace('\n', ' ')}}
...
class ProblemCheckTrackingTest(unittest.TestCase):
    ...
    def test_numerical_textline(self):
        ...
        event = self.get_event_for_answers(module, answer_input_dict)
        assert event['submission'] == {factory.answer_key(2): {'question': '', 'answer': '3.14', 'response_type': 'numericalresponse', 'input_type': 'textline', 'correct': True, 'group_label': '', 'variant': ''}}
    ...
    def test_multiple_inputs(self):
        ...
        event = self.get_event_for_answers(module, answer_input_dict)
        assert event['submission'] == {factory.answer_key(2, 1): {'group_label': group_label, 'question': input1_label, 'answer': 'blue', 'response_type': 'optionresponse', 'input_type': 'optioninput', 'correct': True, 'variant': ''}, factory.answer_key(2, 2): {'group_label': group_label, 'question': input2_label, 'answer': 'yellow', 'response_type': 'optionresponse', 'input_type': 'optioninput', 'correct': False, 'variant': ''}}
    ...
    def test_optioninput_extended_xml(self):
        ...
        event = self.get_event_for_answers(module, answer_input_dict)
        assert event['submission'] == {factory.answer_key(2, 1): {'group_label': group_label, 'question': input1_label, 'answer': 'apple', 'response_type': 'optionresponse', 'input_type': 'optioninput', 'correct': True, 'variant': ''}, factory.answer_key(2, 2): {'group_label': group_label, 'question': input2_label, 'answer': 'cucumber', 'response_type': 'optionresponse', 'input_type': 'optioninput', 'correct': False, 'variant': ''}}
    ...
    def test_rerandomized_inputs(self):
        ...
        event = self.get_event_for_answers(module, answer_input_dict)
        assert event['submission'] == {factory.answer_key(2): {'question': '', 'answer': '3.14', 'response_type': 'numericalresponse', 'input_type': 'textline', 'correct': True, 'group_label': '', 'variant': module.seed}}
    ...
    def test_file_inputs(self):
        ...
        event = self.get_event_for_answers(module, answer_input_dict)
        assert event['submission'] == {factory.answer_key(2): {'question': '', 'answer': fpaths, 'response_type': 'coderesponse', 'input_type': 'filesubmission', 'correct': False, 'group_label': '', 'variant': ''}, factory.answer_key(3): {'answer': 'None', 'correct': True, 'group_label': '', 'question': '', 'response_type': 'customresponse', 'input_type': 'textline', 'variant': ''}}
