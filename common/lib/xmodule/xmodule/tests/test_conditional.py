...
class ConditionalBlockXmlTest(unittest.TestCase):
    ...
    def test_conditional_module_with_empty_sources_list(self):
        ...
        assert conditional.sources_list[0] == BlockUsageLocator.from_string(conditional.xml_attributes['sources']).replace(run=dummy_location.course_key.run)
    ...
    def test_conditional_module_parse_sources(self):
        ...
        assert conditional.parse_sources(conditional.xml_attributes) == ['i4x://HarvardX/ER22x/poll_question/T15_poll', 'i4x://HarvardX/ER22x/poll_question/T16_poll']
