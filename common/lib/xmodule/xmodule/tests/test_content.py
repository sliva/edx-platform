...
class ContentTest(unittest.TestCase):  # lint-amnesty, pylint: disable=missing-class-docstring
    ...
    def test_generate_thumbnail_image(self, original_filename, thumbnail_filename):
        ...
        assert AssetLocator(CourseLocator(u'mitX', u'800', u'ignore_run'), u'thumbnail', thumbnail_filename) == thumbnail_file_location
    ...
    def test_compute_location(self):
        ...
        assert AssetLocator(CourseLocator(u'mitX', u'400', u'ignore', deprecated=True), u'asset', u'subs__1eo_jXvZnE_.srt.sjson') == asset_location
    ...
    def test_get_location_from_path(self):
        ...
        assert AssetLocator(CourseLocator(u'a', u'b', None, deprecated=True), u'asset', u'images_course_image.jpg', deprecated=True) == asset_location
