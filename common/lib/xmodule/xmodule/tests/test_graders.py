...
class ShowCorrectnessTest(unittest.TestCase):
    ...
    def test_show_correctness_always(self, show_correctness, has_staff_access):
        ...
        """
        assert ShowCorrectness.correctness_available(show_correctness=show_correctness, has_staff_access=has_staff_access)
    ...
    def test_show_correctness_never(self, has_staff_access):
        ...
        """
        assert not ShowCorrectness.correctness_available(show_correctness=ShowCorrectness.NEVER, has_staff_access=has_staff_access)
    ...
    def test_show_correctness_past_due(self, due_date_str, has_staff_access, expected_result):
        ...
        * correctness is visible to learners after the due date, when there is a due date.
        ...
        assert ShowCorrectness.correctness_available(ShowCorrectness.PAST_DUE, due_date, has_staff_access) == expected_result
