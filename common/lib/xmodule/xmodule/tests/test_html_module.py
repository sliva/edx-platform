...
class HtmlBlockCourseApiTestCase(unittest.TestCase):
    ...
    def test_disabled(self, settings):
        ...
        with override_settings(**settings):
            assert module.student_view_data() == dict(enabled=False, message='To enable, set FEATURES["ENABLE_HTML_XBLOCK_STUDENT_VIEW_DATA"]')
...
class HtmlBlockIndexingTestCase(unittest.TestCase):
    ...
    def test_index_dictionary_simple_html_module(self):
        ...
        assert descriptor.index_dictionary() == {'content': {'html_content': ' Hello World! ', 'display_name': 'Text'}, 'content_type': 'Text'}
    ...
    def test_index_dictionary_cdata_html_module(self):
        ...
        assert descriptor.index_dictionary() == {'content': {'html_content': ' This has CDATA in it. ', 'display_name': 'Text'}, 'content_type': 'Text'}
    ...
    def test_index_dictionary_multiple_spaces_html_module(self):
        ...
        assert descriptor.index_dictionary() == {'content': {'html_content': ' Text has spaces :) ', 'display_name': 'Text'}, 'content_type': 'Text'}
    ...
    def test_index_dictionary_html_module_with_comment(self):
        ...
        assert descriptor.index_dictionary() == {'content': {'html_content': ' This has HTML comment in it. ', 'display_name': 'Text'}, 'content_type': 'Text'}
    ...
    def test_index_dictionary_html_module_with_both_comments_and_cdata(self):
        ...
        assert descriptor.index_dictionary() == {'content': {'html_content': ' This has HTML comment in it. HTML end. ', 'display_name': 'Text'}, 'content_type': 'Text'}
