...
class ImportTestCase(BaseCourseTestCase):  # lint-amnesty, pylint: disable=missing-class-docstring
    ...
    def course_descriptor_inheritance_check(self, descriptor, from_date_string, unicorn_color, course_run=RUN):
        ...
        assert ImportTestCase.date.to_json(ImportTestCase.date.from_json(from_date_string)) == child.xblock_kvs.inherited_settings['due']
    ...
    def override_metadata_check(self, descriptor, child, course_due, child_due):
        ...
        assert ImportTestCase.date.to_json(ImportTestCase.date.from_json(course_due)) == child.xblock_kvs.inherited_settings['due']
    ...
    def test_poll_and_conditional_import(self):
        ...
        assert module.answers == [{'text': u'Yes', 'id': 'Yes'}, {'text': u'No', 'id': 'No'}, {'text': u"Don't know", 'id': 'Dont_know'}]
