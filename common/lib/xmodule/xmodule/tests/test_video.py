...
class VideoBlockIndexingTestCase(unittest.TestCase):
    ...
    def test_video_with_youtube_subs_index_dictionary(self):
        ...
        assert descriptor.index_dictionary() == {'content': {'display_name': 'Test Video', 'transcript_en': YOUTUBE_SUBTITLES}, 'content_type': 'Video'}
    ...
    def test_video_with_subs_and_transcript_index_dictionary(self):
        ...
        assert descriptor.index_dictionary() == {'content': {'display_name': 'Test Video', 'transcript_en': YOUTUBE_SUBTITLES, 'transcript_ge': 'sprechen sie deutsch? Ja, ich spreche Deutsch'}, 'content_type': 'Video'}
    ...
    def test_video_with_multiple_transcripts_index_dictionary(self):
        ...
        assert descriptor.index_dictionary() == {'content': {'display_name': 'Test Video', 'transcript_ge': 'sprechen sie deutsch? Ja, ich spreche Deutsch', 'transcript_hr': 'Dobar dan! Kako ste danas?'}, 'content_type': 'Video'}
