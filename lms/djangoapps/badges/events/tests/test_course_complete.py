...
class CourseCompleteTestCase(ModuleStoreTestCase):
    ...
    def test_dated_description(self):
        ...
        """
        assert course_complete.badge_description(self.course, 'honor') == 'Completed the course "Badged" (honor, 2015-05-19 - 2015-05-20)'
    ...
    def test_evidence_url(self):
        ...
        assert 'https://edx.org/certificates/{}?evidence_visit=1'.format(cert.verify_uuid) == course_complete.evidence_url(user.id, self.course_key)
