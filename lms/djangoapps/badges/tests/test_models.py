...
class BadgeImageConfigurationTest(TestCase):
    ...
    def test_no_double_default(self):
        ...
        pytest.raises(ValidationError, CourseCompleteImageConfiguration(mode='test2', icon=get_image('good'), default=True).full_clean)

    def test_runs_validator(self):
        """
        Verify that the image validator is triggered when cleaning the model.
        """
        pytest.raises(ValidationError, CourseCompleteImageConfiguration(mode='test2', icon=get_image('unbalanced')).full_clean)
...
class BadgeClassTest(ModuleStoreTestCase):
    ...
    def test_get_badge_class_image_validate(self):
        ...
        """
        pytest.raises(ValidationError, BadgeClass.get_badge_class)
    ...
    def test_get_badge_class_data_validate(self):
        ...
        """
        pytest.raises(IntegrityError, BadgeClass.get_badge_class)
    ...
    def test_runs_validator(self):
        ...
        Verify that the image validator is triggered when cleaning the model.
        """
        pytest.raises(ValidationError, BadgeClass(slug='test', issuing_component='test2', criteria='test3', description='test4', image=get_image('unbalanced')).full_clean)
