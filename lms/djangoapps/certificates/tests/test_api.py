...
class CertificateDownloadableStatusTests(WebCertificateTestMixin, ModuleStoreTestCase):
    ...
    def test_cert_status_with_generating(self):
        ...
        assert certificate_downloadable_status(self.student, self.course.id) == {'is_downloadable': False, 'is_generating': True, 'is_unverified': False, 'download_url': None, 'uuid': None}
    ...
    def test_without_cert(self):
        assert certificate_downloadable_status(self.student_no_cert, self.course.id) == {'is_downloadable': False, 'is_generating': False, 'is_unverified': False, 'download_url': None, 'uuid': None}
    ...
    def verify_downloadable_pdf_cert(self):
        ...
        assert certificate_downloadable_status(self.student, self.course.id) == {'is_downloadable': True, 'is_generating': False, 'is_unverified': False, 'download_url': 'www.google.com', 'is_pdf_certificate': True, 'uuid': cert.verify_uuid}
    ...
    def test_with_downloadable_web_cert(self):
        ...
        assert certificate_downloadable_status(self.student, self.course.id) == {'is_downloadable': True, 'is_generating': False, 'is_unverified': False, 'download_url': '/certificates/{uuid}'.format(uuid=cert_status['uuid']), 'is_pdf_certificate': False, 'uuid': cert_status['uuid']}
