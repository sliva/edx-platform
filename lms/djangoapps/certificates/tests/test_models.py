...
class ExampleCertificateTest(TestCase):
    ...
    def test_update_status_success(self):
        ...
        assert self.cert.status_dict == {'description': self.DESCRIPTION, 'status': ExampleCertificate.STATUS_SUCCESS, 'download_url': self.DOWNLOAD_URL}
    ...
    def test_update_status_error(self):
        ...
        assert self.cert.status_dict == {'description': self.DESCRIPTION, 'status': ExampleCertificate.STATUS_ERROR, 'error_reason': self.ERROR_REASON}
