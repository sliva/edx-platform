...
class CertificateSearchTests(CertificateSupportTestCase):
    ...
    def test_download_link(self):
        ...
        assert retrieved_cert['download_url'] == reverse('certificates:render_cert_by_uuid', kwargs={'certificate_uuid': self.cert.verify_uuid})
...
class CertificateRegenerateTests(CertificateSupportTestCase):
    ...
    def assertInvalidatedCertDoesNotExist(self):
        ...
        assert not CertificateInvalidation.objects.filter(generated_certificate__user=self.student, active=True).exists()
