...
class TestBlockSerializerBase(SharedModuleStoreTestCase):
    ...
    def assert_extended_block(self, serialized_block):
        ...
        """
        assert {'id', 'type', 'lms_web_url', 'student_view_url', 'display_name', 'graded', 'student_view_multi_device', 'lti_url', 'visible_to_staff_only'} <= set(six.iterkeys(serialized_block))
