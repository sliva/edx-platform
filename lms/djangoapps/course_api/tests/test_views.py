...
class CourseListViewTestCaseMultipleCourses(CourseApiTestViewMixin, ModuleStoreTestCase):
    ...
    def test_filter(self):
        ...
        for filter_, expected_courses in test_cases:
            ...
            assert {course['course_id'] for course in response.data['results']} == {six.text_type(course.id) for course in expected_courses}, u'testing course_api.views.CourseListView with filter_={}'.format(filter_)
