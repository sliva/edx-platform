    ...
    def _check_results(self, user, expected_accessible_blocks, blocks_with_differing_access, transformers):
        ...
        for i, xblock_key in enumerate(self.xblock_keys):
            ...
            self.assertEqual(
                ...
                "block_structure return value {} not equal to expected value for block {} for user {}".format(
            ...
            if blocks_with_differing_access:
                ...
                if i in blocks_with_differing_access:
                    self.assertNotEqual(
                        block_structure_result,
                        has_access_result,
                        "block structure ({}) & has_access ({}) results are equal for block {} for user {}".format(
                    ...
                    self.assertEqual(
                        block_structure_result,
                        has_access_result,
                        "block structure ({}) & has_access ({}) results not equal for block {} for user {}".format(
                            block_structure_result, has_access_result, i, user.username
                        )
                    )
