...
class ContentLibraryTransformerTestCase(CourseStructureTestCase):
    ...
    def test_content_library(self):
        ...
        for i in range(5):
            ...
            assert set(trans_block_structure.get_block_keys()) == self.get_block_key_set(self.blocks, 'course', 'chapter1', 'lesson1', 'vertical1', 'library_content1', selected_vertical, selected_child), u"Expected 'selected' equality failed in iteration {}.".format(i)
...
class ContentLibraryOrderTransformerTestCase(CourseStructureTestCase):
    ...
    def test_content_library_randomize(self, mocked):
        ...
        for i in range(5):
            ...
            assert expected_children == [child.block_id for child in children], u"Expected 'selected' equality failed in iteration {}.".format(i)
