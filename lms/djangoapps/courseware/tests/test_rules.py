...
class PermissionTests(ModuleStoreTestCase):
    ...
    def test_proctoring_perm_with_honor_mode_permission(self):
        ...
        assert self.user.has_perm('edx_proctoring.can_take_proctored_exam', {'course_id': str(course_allow_honor.id), 'backend': 'mock_proctoring_allow_honor_mode', 'is_proctored': True})
