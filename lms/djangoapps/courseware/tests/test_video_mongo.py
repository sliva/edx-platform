...
class TestVideoYouTube(TestVideo):  # lint-amnesty, pylint: disable=missing-class-docstring, test-inherits-tests
    ...
    def test_video_constructor(self):
        ...
        assert get_context_dict_from_string(context) == get_context_dict_from_string(self.item_descriptor.xmodule_runtime.render_template('video.html', expected_context))
...
class TestGetHtmlMethod(BaseTestVideoXBlock):
    ...
    def test_get_html_hls(self, get_urls_for_profiles):
        ...
        * HLS source should not be used for download URL If available from edxval
        ...
        assert sorted(['https://webm.com/dw.webm', 'https://mp4.com/dm.mp4', 'https://hls.com/hls.m3u8']) == sorted(get_context_dict_from_string(context)['metadata']['sources'])
...
class VideoBlockTest(TestCase, VideoBlockTestBase):
    ...
    def test_get_context(self):
        ...
        assert rendered_context['transcripts_basic_tab_metadata']['edx_video_id'] == self.descriptor.editable_metadata_fields['edx_video_id']
