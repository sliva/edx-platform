...
class TopicSerializerTestCase(SerializerTestCase):
    ...
    def test_topic_with_no_team_count(self):
        ...
        with self.assertNumQueries(2):
            ...
            assert serializer.data == {u'name': u'Tøpic', u'description': u'The bést topic!', u'id': u'0', u'team_count': 0, u'type': u'open', u'max_team_size': None}
    ...
    def test_topic_with_team_count(self):
        ...
        with self.assertNumQueries(2):
            ...
            assert serializer.data == {u'name': u'Tøpic', u'description': u'The bést topic!', u'id': u'0', u'team_count': 1, u'type': u'open', u'max_team_size': None}
...
class BaseTopicSerializerTestCase(SerializerTestCase):
    ...
    def assert_serializer_output(self, topics, num_teams_per_topic, num_queries):
        ...
        with self.assertNumQueries(num_queries):
            ...
            assert serializer.data['results'] == [self._merge_dicts(topic, {u'team_count': num_teams_per_topic}) for topic in topics]
...
class BulkTeamCountTopicSerializerTestCase(BaseTopicSerializerTestCase):
    ...
    def assert_serializer_output(self, topics, num_teams_per_topic, num_queries):
        ...
        with self.assertNumQueries(num_queries):
            ...
            assert serializer.data == [self._merge_dicts(topic, {u'team_count': num_teams_per_topic}) for topic in topics]
