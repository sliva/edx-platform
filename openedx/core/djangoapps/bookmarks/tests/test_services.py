...
class BookmarksServiceTests(BookmarksTestsBase):
    ...
    def test_set_bookmarked(self):
        ...
        with self.assertNumQueries(0):
            assert not self.bookmark_service.set_bookmarked(usage_key=UsageKey.from_string('i4x://ed/ed/ed/interactive'))
    ...
    def test_unset_bookmarked(self):
        ...
        """
        with self.assertNumQueries(1):
            assert not self.bookmark_service.unset_bookmarked(usage_key=UsageKey.from_string('i4x://ed/ed/ed/interactive'))
