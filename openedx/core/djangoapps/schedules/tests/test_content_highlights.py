...
class TestContentHighlights(ModuleStoreTestCase):  # lint-amnesty, pylint: disable=missing-class-docstring
    ...
    def test_get_next_section_highlights(self, mock_duration):
        ...
        assert get_next_section_highlights(self.user, self.course_key, two_days_ago, today.date()) == (['skipped a week'], 2)
        ...
        assert get_next_section_highlights(self.user, self.course_key, two_days_ago, four_days.date()) == (['final week!'], 4)
