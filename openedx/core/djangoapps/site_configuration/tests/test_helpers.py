...
class TestHelpers(TestCase):
    ...
    def test_get_value(self):
        ...
        assert configuration_helpers.get_value('course_about_show_social_links') == test_config['course_about_show_social_links']
    ...
    def test_get_value_for_org(self):
        ...
        with with_site_configuration_context(configuration=test_config):
            ...
            assert configuration_helpers.get_value_for_org(test_org, 'css_overrides_file') == test_config['css_overrides_file']
            ...
            assert configuration_helpers.get_value_for_org(test_org, 'non_existent_key', 'default for non existent') == 'default for non existent'
            assert configuration_helpers.get_value_for_org('missing_org', 'university', 'default for non existent') == 'default for non existent'
