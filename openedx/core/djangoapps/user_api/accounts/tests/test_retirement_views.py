...
class TestAccountRetirementCleanup(RetirementTestCase):
    ...
    def test_leaves_other_users(self):
        ...
        self.cleanup_and_assert_status()
        assert UserRetirementStatus.objects.filter(user__username__in=remaining_usernames).count() == len(remaining_usernames)
...
class TestLMSAccountRetirementPost(RetirementTestCase, ModuleStoreTestCase):
    ...
    def test_retire_user(self):
        ...
        assert ManualEnrollmentAudit.objects.get(enrollment=CourseEnrollment.objects.get(user=self.test_user)).enrolled_email == retirement.retired_email
