...
class FormDescriptionTest(TestCase):
    ...
    def test_option_overrides(self):
        ...
        assert desc.fields[0]['options'] == [{'default': False, 'name': 'United States of America', 'value': 'US'}, {'default': True, 'name': 'Pakistan', 'value': 'PK'}]
