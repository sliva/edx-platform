...
class LoginTest(SiteMixin, CacheIsolationTestCase):
    ...
    def test_public_login_failure_with_only_third_part_auth_enabled(self):
        ...
        assert response.content == b'Third party authentication is required to login. Username and password were received instead.'
...
class LoginSessionViewTest(ApiTestCase):
    ...
    def test_login_form(self):
        ...
        assert form_desc['fields'] == [{'name': 'email', 'defaultValue': '', 'type': 'email', 'required': True, 'label': 'Email', 'placeholder': '', 'instructions': 'The email address you used to register with {platform_name}'.format(platform_name=settings.PLATFORM_NAME), 'restrictions': {'min_length': EMAIL_MIN_LENGTH, 'max_length': EMAIL_MAX_LENGTH}, 'errorMessages': {}, 'supplementalText': '', 'supplementalLink': '', 'loginIssueSupportLink': 'https://support.example.com/login-issue-help.html'}, {'name': 'password', 'defaultValue': '', 'type': 'password', 'required': True, 'label': 'Password', 'placeholder': '', 'instructions': '', 'restrictions': {'max_length': DEFAULT_MAX_PASSWORD_LENGTH}, 'errorMessages': {}, 'supplementalText': '', 'supplementalLink': '', 'loginIssueSupportLink': 'https://support.example.com/login-issue-help.html'}]
